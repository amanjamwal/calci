...
class SubtractActionTest {
    ...
    public void getIdentifier() {
        Action subtractAction = new SubtractAction(mockOperandStore, mockOperationHistory);
    ...
    public void executeInsufficientArguments() throws CalciException {
        ...
        Assertions.assertThrows(InsufficientParametersException.class, subtractAction::execute);
    }
}
