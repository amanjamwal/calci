...
class DivideActionTest {
    ...
    public void getIdentifier() {
        Action divideAction = new DivideAction(mockOperandStore, mockOperationHistory);
    ...
    public void executeInsufficientArguments() throws CalciException {
        ...
        Assertions.assertThrows(InsufficientParametersException.class, divideAction::execute);
    }
}
